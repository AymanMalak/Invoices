                    ...
                    <form action="{{ route('invoices.update') }}" method="post"
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control" id="invoice_name" value="{{$invoice->invoice_number}}" name="invoice_number"
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control" id="tahsel" value="{{$invoice->amount_collection}}"  name="amount_collection"
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" value="{{$invoice->amount_commission}}" id="amount_commission"
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control" value="{{$invoice->value_vat}}" id="value_vat" name="value_vat" readonly>
                            </div>

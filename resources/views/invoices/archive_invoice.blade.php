...
@section('content')
    ...
    <div class="row">
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown dropbottom">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                        ...
                                                        data-toggle="modal" data-target="#restore_invoice"
                                                        data-invoice_id="{{ $invoice->id }}" title="الغاء الارشفة">
                                                        الغاء الارشفة
                                                    </a>
        ...
        {{-- restore invoice --}}
        <div class="modal fade" id="restore_invoice" role="effect-flip-horizontal" style="display: none;"
            aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered " role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-header">
                        <h6 class="modal-title">الغاء الارشفة</h6><button aria-label="Close" class="close"
                            data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
                    </div>

                    <div class="modal-body">
                        <form action="{{ route('restore_invoice') }}" method="post" autocomplete="off">
                            {{ method_field('patch') }}
                            {{ csrf_field() }}
                            <div class="form-group">
                                هل انت متأكد من الغاء الارشفة؟
                                <input type="hidden" class="form-control " id="invoice_id" name="invoice_id">
                            </div>
...
@section('js')
    ...
    <script>
        ...
        $('#restore_invoice').on('shown.bs.modal', function(event) {
